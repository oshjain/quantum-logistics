            ...
            <FadeInView direction="up">
              <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-2">
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <Globe className="size-3.5 mx-auto mb-1 text-primary" />
                  <p className="text-base font-bold font-mono"><AnimatedCounter to={pageAnalytics?.totalPages ?? 0} duration={1} /></p>
                  <p className="text-[9px] font-mono text-muted-foreground">Total Pages</p>
                </div>
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <Eye className="size-3.5 mx-auto mb-1 text-cyan-400" />
                  <p className="text-base font-bold font-mono text-cyan-400"><AnimatedCounter to={pageAnalytics?.totalVisits ?? 0} duration={1} /></p>
                  <p className="text-[9px] font-mono text-muted-foreground">Visits</p>
                </div>
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <Users className="size-3.5 mx-auto mb-1 text-purple-400" />
                  <p className="text-base font-bold font-mono text-purple-400"><AnimatedCounter to={pageAnalytics?.uniqueUsers ?? 0} duration={1} /></p>
                  <p className="text-[9px] font-mono text-muted-foreground">Users</p>
                </div>
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <Activity className="size-3.5 mx-auto mb-1 text-emerald-400" />
                  <p className="text-base font-bold font-mono text-emerald-400">{pageAnalytics?.avgVisitsPerPage ?? "—"}</p>
                  <p className="text-[9px] font-mono text-muted-foreground">Avg/Page</p>
                </div>
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <BarChart3 className="size-3.5 mx-auto mb-1 text-sky-400" />
                  <p className="text-base font-bold font-mono text-sky-400">{pageAnalytics?.avgVisitsPerUser ?? "—"}</p>
                  <p className="text-[9px] font-mono text-muted-foreground">Visits/User</p>
                </div>
                <div className="rounded-xl border border-border/40 bg-card/50 p-3 text-center">
                  <Percent className="size-3.5 mx-auto mb-1 text-amber-400" />
                  <p className="text-base font-bold font-mono text-amber-400">{pageAnalytics?.pageConcentration ?? 0}%</p>
                  <p className="text-[9px] font-mono text-muted-foreground">Top Page Share</p>
                </div>
              </div>
            </FadeInView>
                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 bg-card/95 backdrop-blur-sm z-10">
                      <tr className="border-b border-border/30">
                        ...
                        <th className="text-center px-2 py-3 text-[10px] font-mono text-muted-foreground uppercase tracking-wider">Share</th>
                        <th className="text-center px-2 py-3 text-[10px] font-mono text-muted-foreground uppercase tracking-wider">Users</th>
                        <th className="text-center px-2 py-3 text-[10px] font-mono text-muted-foreground uppercase tracking-wider">Depth</th>
                        <th className="text-center px-2 py-3 text-[10px] font-mono text-muted-foreground uppercase tracking-wider">Last</th>
                        ...
                        processedPages.map((p) => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-4 py-3">
                                <div className="flex items-center gap-2.5">
                                  ...
                                  <div className="min-w-0">
                                    ...
                                    <p className="text-[10px] font-mono text-muted-foreground truncate max-w-[200px]">{p.page}</p>
                                  </div>
                                </div>
                              </td>
                              ...
                              <td className="px-2 py-3 text-center">
                                <span className="text-xs font-mono text-amber-400">{p.trafficShare ?? 0}%</span>
                              </td>
                              <td className="px-2 py-3 text-center">
                                <span className="text-xs font-mono text-purple-400">{p.uniqueUsers}</span>
                              </td>
                              <td className="px-2 py-3 text-center">
                                <span className="text-xs font-mono text-muted-foreground">{p.visitDepth ?? "—"}</span>
                              </td>
                              <td className="px-2 py-3 text-center">
